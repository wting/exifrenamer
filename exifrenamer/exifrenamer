#!/usr/bin/env python
# Copyright (c) William Ting 2009-2012
# All rights reserved
# Site: https://github.com/wting/exifrenamer
#
...
def set_options():
	...
	description="Copies images and raw files with the same name within SOURCE to DEST, renaming the file based on the EXIF timestamp."
...
def build_list():
	"""
	Traverses through source directory, checks for valid images, extracts EXIF timestamp,
